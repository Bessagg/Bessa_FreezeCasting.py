...
df_var_importance['variable'].replace(
    {'name_fluid1': 'Fluid name', 'material': 'Solid', 'material_group': 'Sample group',
     'temp_cold': 'Freezing Temp', 'cooling_rate': 'Freezing Rate', 'time_sub': 'Sublim time',
     'time_sinter_1': 'Sinter time', 'temp_sinter_1': 'Sinter Temp',
     'porosity': 'Porosity', 'vf_solid': 'Solid Volume Fraction', 'vf_part_1': "Solid Volume Fraction 1",
     'vf_fluid_1': "Fluid Volume Fraction"}, inplace=True)
...
plt.tight_layout()
g.set_axis_labels("Parâmetro", "Scaled Importance")
